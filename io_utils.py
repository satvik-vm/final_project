...
def parse_args(script):
    ...
    if script == 'train':
        ...
        parser.add_argument('--bottleneck', default=2, type=int, help='to declare bottle for dnn model')
        parser.add_argument('--print_batch_freq' , default=50, type=int, help='continue from baseline, neglected if resume is true')
        parser.add_argument('--warmup'      , action='store_true', help='continue from baseline, neglected if resume is true') #never used in the paper
        parser.add_argument('--without_mixup'      , action='store_true', help='continue from baseline, neglected if resume is true')
